...
public class DomainUtils {
    ...
    // controllers
    private static DomainUtils INSTANCE = null;
    // 对应网络方面的操作
...
//    private GameServer GAME = null;
    ...
    public static DomainUtils getInstance() {
        if (INSTANCE == null) {
            ...
            INSTANCE.mSocketManager = SocketManager.getInstance();
//            INSTANCE.GAME = GameServer.getInstance();
    ...
    public void setServerName(String serverName) {
        this.serverName = TextUtils.isEmpty(serverName) ? "Rokid Glass" : serverName;
...
//			handlerUI.sendMessage(msg);
            ...
            Logger.d("OneClientToServer, winPlayer="+winPlayer);
            mSocketManager.sendUpdatedBoardClients(winPlayer);
    ...
    public void serverTCPStart() throws Exception {
        ...
        mSocketManager.serverTCPStart();
    }

    // 停止&退出TCP线程
    public void serverTCPStop() {
        mSocketManager.serverTCPStop();
    }
    ...
    public void serverTCPConnect(String serverIP, int serverPort) throws Exception {
        ...
        this.gameRunning = false;
        String result = mSocketManager.serverTCPConnect(serverIP, serverPort); // 连接服务端， 服务器会返回分配的playerID, teamID
    }

    public void serverTCPDisconnect() {
        this.mode = 0;
        this.gameRunning = false;
        mSocketManager.serverTCPDisconnect();
    }

    public void serverTCPDisconnectClients() {
        this.mode = 0;
        this.gameRunning = false;
        mSocketManager.serverTCPDisconnectClients();
    }
    ...
    public void updatedPlayers() {
        ...
        //mSocketManager.sendSignals("WAITINGROOM " + serialize(r));
    }
    ...
    public int getPlayerCount() {
        return mSocketManager.getInstance().getPlayerCount();
    }

    // 发送文本
    public void sendMessage(String text) {
        try {
            this.mSocketManager.sendUpdatedBoardServer(text);
        } catch (Exception e) {
    ...
    public void startGame() {
        ...
        //this.GAME.setPlayers(this.mSocketManager.serverTCPGetConnectedPlayersName());

        // 随机产生4张牌,并发送给各个客户端
        //this.GAME.InitRandomPorks();
        this.mSocketManager.sendSignalsStartGame();
    }
    ...
    public void stopGame() {
        ...
        } else if (mode == DomainUtils.MODE_SERVER) {
